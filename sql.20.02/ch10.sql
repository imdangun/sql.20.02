...
commit;
delete depts; -- error, fk ����

insert into depts values(100, 'Marketing'); -- error, pk����
insert into depts values(null, 'Marketing'); --error, pk����

insert into emps values(
  501, null, 'good@gmail.com', 6000, 100); -- error, nn����
insert into emps values(
  501, 'abel', 'musk@gmail.com', 6000, 100); --error, uk����
insert into emps values(
  501, 'abel', 'good@gmail.com', 900, 100); --error, ck����
insert into emps values(
  501, 'abel', 'good@gmail.com', 6000, 200); --error, fk����
--
